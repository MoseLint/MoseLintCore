...
public class MethodsClassReaderTests {
	...
	public void testReadMethodType() {
		...
		Assertions.assertTrue(functions.get(0).getReturnType().getType() instanceof VoidType,
				"parameterTest should return a voidType however returns " + functions.get(0)
						.getReturnType()
						.getType()
						.getName());
		Assertions.assertEquals("testHelloWorld", functions.get(1).getName());
		Assertions.assertTrue(functions.get(2).getReturnType().getType() instanceof VoidType,
				"testMethod should return a voidType however returns " + functions.get(0)
						.getReturnType()
						.getType()
						.getName());
